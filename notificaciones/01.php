...
<head>
	...
	<!-- fin letras Letras google Font-->
 	...
 	<title>Usuario y/o contraseña incorrecta</title>
 </head>
<BODY>

<div class="col-xs-3 col-md-3 col-sm-6 center-block quitar-float text-center espacio-arriba">
	<img src="../img/imgVe/neg.png" class="animated fadeInDown ">
	<h2 class="mediano animated fadeInDown retraso-1">Usuario y/o contraseña incorrecta<h2>	
	<nav>
		
		<a class="animated fadeInDown retraso-1 peque" href="../index.php" class="espacio-derecha">Volver a Intentarlo </a>
