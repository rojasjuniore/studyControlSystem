...
<div class="col-xs-3 col-md-3 col-sm-6 center-block quitar-float text-center espacio-arriba">
	...
	<h2 class="mediano animated fadeInDown retraso-1">Datos ingresados correctamente.<h2>	
	<nav>
		<a class="animated fadeInDown retraso-1 peque" href="../registroVehiculos.php" class="espacio-derecha">ir a Registrar de Vehiculos</a><br>
